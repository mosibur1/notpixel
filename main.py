...
def reset_proxy():
    with open('proxy.txt', 'w') as file:
        file.write('')
    log_message("Proxy data reset successfully", Fore.YELLOW)
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝            ╚═╝   ╚══════╝ ╚═════╝╚═╝  ╚═╝
    ...
    print(" made and written by MRP Tech || @mosibur_paik")
    print("Join telegram channel: https://t.me/mrptechofficial")
